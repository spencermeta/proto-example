...
func (x *MaxResponse) GetMax() float64 {
	if x != nil {
		return x.Max
	}
	return 0
...
var file_calc_calcpb_calc_proto_rawDesc = []byte{
	...
	0x6c, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x61, 0x6c, 0x63, 0x22, 0x4a,
	...
	0x65, 0x72, 0x22, 0x28, 0x0a, 0x0e, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x2b, 0x0a, 0x0f,
	...
	0x52, 0x07, 0x61, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x22, 0x24, 0x0a, 0x0a, 0x4d, 0x61, 0x78,
	...
	0x0a, 0x03, 0x6d, 0x61, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x03, 0x6d, 0x61, 0x78,
	...
	0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x28, 0x0a,
	...
	0x01, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x32, 0xdb, 0x02, 0x0a, 0x0b, 0x43, 0x61, 0x6c, 0x63,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x0a, 0x53, 0x71, 0x75, 0x61, 0x72, 0x65, 0x52,
	...
	0x00, 0x28, 0x01, 0x12, 0x30, 0x0a, 0x03, 0x4d, 0x61, 0x78, 0x12, 0x10, 0x2e, 0x63, 0x61, 0x6c,
	0x63, 0x2e, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x63,
	0x61, 0x6c, 0x63, 0x2e, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0d, 0x5a, 0x0b, 0x63, 0x61, 0x6c, 0x63, 0x2f, 0x63, 0x61,
...
var file_calc_calcpb_calc_proto_goTypes = []interface{}{
	...
	(*MaxRequest)(nil),                       // 6: calc.MaxRequest
	(*MaxResponse)(nil),                      // 7: calc.MaxResponse
...
var file_calc_calcpb_calc_proto_depIdxs = []int32{
	...
	8, // 1: calc.CalcService.SquareRoot:input_type -> calc.SquareRootRequest
	2, // 2: calc.CalcService.PrimeNumberDecomposition:input_type -> calc.PrimeNumberDecompositionRequest
	4, // 3: calc.CalcService.Average:input_type -> calc.AverageRequest
	6, // 4: calc.CalcService.Max:input_type -> calc.MaxRequest
	1, // 5: calc.CalcService.Sum:output_type -> calc.SumResponse
	9, // 6: calc.CalcService.SquareRoot:output_type -> calc.SquareRootResponse
	3, // 7: calc.CalcService.PrimeNumberDecomposition:output_type -> calc.PrimeNumberDecompositionResponse
	5, // 8: calc.CalcService.Average:output_type -> calc.AverageResponse
	7, // 9: calc.CalcService.Max:output_type -> calc.MaxResponse
